...
def main():
    ...
    parser.add_argument("--threshold", type=float, help="(IEF_LGBM, IEF_FFNN) Threshold of prediction when evaluating a model.", default=0.5)
    parser.add_argument("--thresholds", type=str, help="(IEF_ALL) Several thresholds of prediction when evaluating a model, separated by comma. Default is '0.5,0.6,0.7,0.8'.", default="0.5,0.6,0.7,0.8")
